        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
            {[
              ...
              { label: "Deep Learning", desc: "ML using layered neural networks — the engine behind LLMs, image AI, and voice recognition.", icon: "??" },
              { label: "LLMs", desc: "Large Language Models like ChatGPT — trained on vast text to generate and understand language.", icon: "??" },
            ].map(({ label, desc, icon }) => (
