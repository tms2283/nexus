...
const toolsLinks = [
  { href: "/flashcards", label: "Flashcards", Icon: Brain, desc: "Spaced repetition" },
  { href: "/mindmap", label: "Mind Maps", Icon: Network, desc: "Visual concept maps" },
  { href: "/settings", label: "AI Settings", Icon: Settings2, desc: "Provider & API keys" },
  { href: "/testing", label: "Testing Center", Icon: Target, desc: "Assess your knowledge" },
  { href: "/dashboard", label: "My Progress", Icon: BarChart3, desc: "Track your learning" },
  { href: "/leaderboard", label: "Leaderboard", Icon: Trophy, desc: "Global XP rankings" },
  { href: "/study-buddy", label: "Study Buddy", Icon: BookOpen, desc: "AI-powered tutoring" },
  { href: "/daily", label: "Daily Challenge", Icon: Flame, desc: "Today's AI challenge" },
  { href: "/progress", label: "Progress", Icon: TrendingUp, desc: "Your learning stats" },
  { href: "/reading-list", label: "Reading List", Icon: BookMarked, desc: "Saved resources" },
  { href: "/skills", label: "Skill Tree", Icon: Layers, desc: "Your skill mastery" },
  { href: "/profile", label: "Profile", Icon: User, desc: "Your account & preferences" },
];
                    ...
                    {toolsLinks.map(({ href, label, Icon, desc }) => {
                      ...
                      return (
                        <Link key={href} href={href}>
                          <div className={`flex items-center gap-3 px-4 py-3 transition-colors cursor-pointer ${isActive ? "bg-[oklch(0.75_0.18_55_/_0.12)]" : "hover:bg-white/5"}`}>
                            <div className="p-1.5 rounded-lg bg-violet-500/10">
                              <Icon size={14} className="text-violet-400" />
                            </div>
                            <div>
                              <p className={`text-sm font-medium ${isActive ? "text-[oklch(0.85_0.18_55)]" : "text-foreground"}`}>{label}</p>
          ...
          >
            <div className="container py-4 flex flex-col gap-1">
              ...
              <div className="border-t border-white/5 mt-2 pt-2">
                <p className="text-xs text-muted-foreground px-4 py-1 uppercase tracking-widest">Tools</p>
                {toolsLinks.map(({ href, label, Icon, desc }) => {
                  const isActive = location === href;
                  return (
                    <Link key={href} href={href}>
                      <div className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive ? "bg-[oklch(0.75_0.18_55_/_0.12)] text-[oklch(0.85_0.18_55)]" : "text-muted-foreground hover:text-foreground hover:bg-white/5"}`}>
